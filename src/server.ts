...
export function createServer(): McpServer {
  ...
  server.tool(
    ...
    "Generate an image from a text prompt using Google Gemini. Supports smart model routing, multiple aspect ratios, and optional Google Search grounding.",
    {
      ...
      model: z
        .enum(["gemini-3.1-flash-image-preview", "gemini-3-pro-image-preview", "auto"])
        .default("auto")
        .describe(
          "Model to use. 'auto' enables smart routing (NB2/Flash default, Pro for complex/4K/high-thinking)"
        ),
      aspect_ratio: z
